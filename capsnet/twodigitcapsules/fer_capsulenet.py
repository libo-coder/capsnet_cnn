...
Usage:
       ...
       python capsnet/twodigitcapsules/fer_capsulenet.py --epochs 50
       python capsnet/twodigitcapsules/fer_capsulenet.py --epochs 50 --routings 3
...
def train(model, args):
    ...
    # Training
    model.fit_generator(generator=fer2013.get_train_generator_for_capsnet(args.batch_size),
                        steps_per_epoch=int(fer2013.TRAIN_SIZE / args.batch_size),
                        epochs=args.epochs,
                        validation_data=fer2013.get_validation_data_for_capsnet(),
...
def test(model, args):
    x_test, y_test = fer2013.get_test_data_for_capsnet()
...
if __name__ == "__main__":
    ...
    # define model
    model, eval_model, manipulate_model = CapsNet(input_shape=fer2013.IMAGE_SHAPE,
                                                  n_class=fer2013.CLASSES,
