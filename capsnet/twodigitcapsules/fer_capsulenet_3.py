"""
Usage:
       python capsnet/twodigitcapsules/fer_capsulenet.py
       python capsnet/twodigitcapsules/fer_capsulenet.py --epochs 5
       python capsnet/twodigitcapsules/fer_capsulenet.py --epochs 5 --routings 3
       python capsnet/twodigitcapsules/fer_capsulenet.py --primary_capsules=32 --number_of_primary_channels=16 --digit_capsules=16
       ... ...
