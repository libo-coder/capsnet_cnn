...
from CapsNet_vs_CNN.capsnet.singledigitcapsule.capsulelayers import CapsuleLayer, PrimaryCap, Length, Mask
from CapsNet_vs_CNN.capsnet.singledigitcapsule.utils import combine_images, plot_log
...
def CapsNet(input_shape, n_class, routings, primary_capsules=16, number_of_primary_channels=32, digit_capsules=16):
    ...
    conv1 = keras.layers.Conv2D(filters=256, kernel_size=9, strides=2, padding='valid', name='conv1',
    ...
    primarycaps = PrimaryCap(conv1, dim_capsule=primary_capsules, n_channels=number_of_primary_channels,
...
def train(model, args):
    ...
    # Training
    model.fit_generator(generator=fer2013_4.get_train_generator_for_capsnet(args.batch_size),
                        steps_per_epoch=int(fer2013_4.TRAIN_SIZE / args.batch_size),
                        epochs=args.epochs,
                        validation_data=fer2013_4.get_validation_data_for_capsnet(),
...
def test(model, args):
    x_test, y_test = fer2013_4.get_test_data_for_capsnet()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Capsule Network on FER2013.")
    ...
    parser.add_argument('--save_dir',
                        default='/home/wh/chen/pycharm/CapsNet_vs_CNN/capsnet/singledigitcapsule/result/fer_singlecaps_4(5)')
    ...
    # define model
    model, eval_model, manipulate_model = CapsNet(input_shape=fer2013_4.IMAGE_SHAPE,
                                                  n_class=fer2013_4.CLASSES,
