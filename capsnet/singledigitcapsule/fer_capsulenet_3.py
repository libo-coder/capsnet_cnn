...
def train(model, args):
    ...
    # Training
    model.fit_generator(generator=fer2013_3.get_train_generator_for_capsnet(args.batch_size),
                        steps_per_epoch=int(fer2013_3.TRAIN_SIZE / args.batch_size),
                        epochs=args.epochs,
                        validation_data=fer2013_3.get_validation_data_for_capsnet(),
...
def test(model, args):
    x_test, y_test = fer2013_3.get_test_data_for_capsnet()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='/home/wh/chen/pycharm/CapsNet_vs_CNN/capsnet/singledigitcapsule/result/result')
    ...
    # define model
    model, eval_model, manipulate_model = CapsNet(input_shape=fer2013_3.IMAGE_SHAPE,
                                                  n_class=fer2013_3.CLASSES,
