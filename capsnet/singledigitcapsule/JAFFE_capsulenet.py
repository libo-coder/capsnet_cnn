...
from CapsNet_vs_CNN.dataset import jaffe
...
def train(model, args):
    ...
    # Training
    model.fit_generator(generator=jaffe.get_train_generator_for_capsnet(args.batch_size),
                        steps_per_epoch=int(jaffe.TRAIN_SIZE / args.batch_size),
                        epochs=args.epochs,
                        validation_data=jaffe.get_validation_data_for_capsnet(),
...
def test(model, args):
    x_test, y_test = jaffe.get_test_data_for_capsnet()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir',
                        default='/home/wh/chen/pycharm/CapsNet_vs_CNN/capsnet/singledigitcapsule/result/JAFFE_singlecaps')
    ...
    # define model
    model, eval_model, manipulate_model = CapsNet(input_shape=jaffe.IMAGE_SHAPE,
                                                  n_class=jaffe.CLASSES,
