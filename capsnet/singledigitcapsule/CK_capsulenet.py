...
def CapsNet(input_shape, n_class, routings, primary_capsules=16, number_of_primary_channels=32, digit_capsules=16):
    ...
    conv1 = keras.layers.Conv2D(filters=256, kernel_size=9, strides=2, padding='valid', name='conv1', activation='relu',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='result/CK_singlecaps(2)')
