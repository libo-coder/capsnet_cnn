...
def resnet_v2(input_shape, depth, num_classes=7):
    ...
    outputs = keras.layers.Dense(fer2013_3.CLASSES,
                                 activation='softmax',
...
if __name__ == '__main__':
    model = resnet_v2(input_shape=fer2013_3.IMAGE_SHAPE, depth=depth)
    ...
    # model.fit_generator(fer2013_3.get_train_generator_for_cnn(batch_size),
    #                     steps_per_epoch=fer2013_3.TRAIN_SIZE / batch_size,
    #                     validation_data=fer2013_3.get_validation_data_for_cnn(),
    #                     epochs=epochs,
    #                     verbose=1,
    #                     workers=1,
    #                     callbacks=callbacks)
    train_history = model.fit_generator(fer2013_3.get_train_generator_for_cnn(batch_size),
                                        steps_per_epoch=fer2013_3.TRAIN_SIZE / batch_size,
                                        validation_data=fer2013_3.get_validation_data_for_cnn(),
                                        epochs=epochs,
                                        verbose=1,
    ...
    # Score trained model.
    x_test, y_test = fer2013_3.get_test_data_for_cnn()
